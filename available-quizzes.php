    ...
    <aside>
        <nav class="sidebar">
          ...
          <div class="sidebar-links">
            <ul>
              <li>
                <a href="index.php" title="Dashboard" class="tooltip">
              ...
              <li>
                <a href="analytics.php" title="Analytics" class="tooltip">
...
<?php endif; ?>
  <div class="dashboard">
    <div class="your-progress">
        <div class="container">
          <p class="intro">Quizzy is an engaging quiz application designed to challenge and enhance users' knowledge across various subjects.</p>
